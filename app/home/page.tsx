...
export default function Home(){
    return <>
        <div className="relative w-full h-[350px] bg-[#f5f0ea] flex flex-col items-center justify-center px-12">
        ...
        />
            ...
            <div className="relative z-10 flex flex-col leading-none justify-center items-center">
                ...
                <p className="text-[#8c8a8bcc] text-[20px]  font-serif justify-center items-center">Pure Coffee, pure community, pure experience, because you</p> 
                <p className="text-[#8c8a8bcc] text-[20px] font-serif justify-center items-center">can never have to much coffee in your life</p>
